        ...
        $.each(search_tools_array[0], function(i, item){
            ...
            if(search_method == 'blog'){
                ...
                if(res.match(v.toLowerCase())){
                    ...
                    if(search_type == 'd'){
                        $(".search_output .row").append('<div class="col-md-12 py-2"><img src="https://cdn.histream.me/tools/admin-images/'+admin_pic+'" alt="'+admin_name+'" class="img-fluid aurthor_img"><a href="'+base_url+'blog/'+item.p_link+'" class="icon_sty px-1">'+match+'</a></div>');
                    }else{
                        $(".mob_search .search_output .row").append('<div class="col-md-12 py-2 d-flex"><img src="https://cdn.histream.me/tools/admin-images/'+admin_pic+'" alt="'+admin_name+'" class="img-fluid aurthor_img"><a href="'+base_url+'blog/'+item.p_link+'" class="icon_sty px-1">'+match+'</a></div>');
                    }
                }
            }else{
